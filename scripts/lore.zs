...
<contenttweaker:unstable_sand>.addTooltip("§9Placeholder Texture! Join the Discord to texture this item.");
...
<contenttweaker:chrono_absolution>.addTooltip("§9Placeholder Texture! Join the Discord to texture this item.");
...
<timeisup:timer_anchor:*>.addTooltip("§9Placeholder Texture! Join the Discord to texture this item.");
